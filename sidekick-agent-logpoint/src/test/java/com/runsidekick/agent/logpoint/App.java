...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        LogPointSupport.putLogPoint(UUID.randomUUID().toString(), Hello.class.getName(), 19, "yasin@thundra.io", logExpression, null, null, -1, -1, true, "INFO", false, false);
        LogPointSupport.putLogPoint(UUID.randomUUID().toString(), Hello.class.getName(), 27, "yasin@thundra.io", logExpression2, null, "idx > 0", -1, -1,true, "INFO", false, false);
        LogPointSupport.putLogPoint(UUID.randomUUID().toString(), CollectionTest.class.getName(), 12, "yasin@thundra.io", logExpression4List3, "t.doubleVal % 3 != 0", null, -1, -1,true, "INFO", false, false);
        LogPointSupport.putLogPoint(UUID.randomUUID().toString(), CollectionTest.class.getName(), 14, "yasin@thundra.io", logExpression4List, null, null, -1, -1,true, "INFO", false, false);
        LogPointSupport.putLogPoint(UUID.randomUUID().toString(), CollectionTest.class.getName(), 15, "yasin@thundra.io", logExpression4List2, null, null, -1, -1,true, "INFO", false, false);
