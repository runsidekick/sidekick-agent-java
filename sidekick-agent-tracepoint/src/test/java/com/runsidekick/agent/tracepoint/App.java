...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TracePointSupport.putTracePoint(tracePointId1, Hello.class.getName(), 19, "serkan@thundra.io", null, "name==\"kaan\" AND i > 0", -1, -1, true, false, null);
        TracePointSupport.putTracePoint(tracePointId2, Hello.class.getName(), 27, "serkan@thundra.io", null, "idx > 0", -1, -1, true, false, null);
