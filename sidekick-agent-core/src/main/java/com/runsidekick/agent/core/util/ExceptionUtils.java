...
public final class ExceptionUtils {
    ...
    private static final int MAX_COMPRESSED_EXCEPTION_STACK_TRACE_DEPTH =
            Integer.getInteger("sidekick.agent.exception.maxcompressedexceptionstacktracedepth", 20);
    private static final boolean DISABLE_COMPRESSED_EXCEPTION =
            Boolean.getBoolean("sidekick.agent.exception.disablecompressedexception");
